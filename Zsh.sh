#
date | lolcat
echo "maker of tool - Hckers _tech "

figlet -f big -c hackers tech | lolcat
...
if [ "$k" == 1 ];
then    
echo "figlet -f digital $n | lolcat ">>/.zshrc
echo -e "\e[1;32m design has been set done !!!"
elif [ "$k" == 2 ]
then
echo "figlet -f slant $n | lolcat ">>/.zshrc
echo "done "
elif [ "$k" == 3 ]
then
echo "figlet -f bubble $n | lolcat ">>/.zshrc
echo "done "

elif [ "$k" == 4 ]
then
echo "figlet -f script $n | lolcat ">>/.zshrc
echo "done."
elif [ "$k" == 5 ]
then
echo "figlet -f block $n | lolcat ">>/.zshrc
echo "done "
elif [ "$k" == 6 ]
then
echo "figlet -f mnemonic $n | lolcat ">>/.zshrc
echo "done "
elif [ "$k" == 7 ]
then
echo "figlet -f big $n | lolcat ">>/.zshrc
echo "done "
elif [ "$k" == 8 ]
then
echo "figlet -f mini $n | lolcat ">>/.zshrc
echo "done"
elif [ "$k" == 9 ]
then
echo "figlet -f banner $n | lolcat ">>/.zshrc
echo "done "
elif [ "$k" == 10 ]
then
echo "figlet -f standard $n | lolcat ">>/.zshrc
echo "done "
elif [ "$k" == 11 ]
then
echo "figlet -f lean $n | lolcat ">>/.zshrc
echo "done"
elif [ "$k" == 12 ]
then
echo "figlet -f smslant $n | lolcat ">>/.zshrc
echo "done "
elif [ "$k" == 13 ]
then
echo "figlet -f small $n | lolcat ">>/.zshrc
echo "done"
elif [ "$k" == 14 ]
then
echo "figlet -f ivrit $n| lolcat ">>/.zshrc
echo "done"
elif [ "$k" == 15 ]
then
echo "figlet -f smscript | lolcat ">>/.zshrc
echo "done"
elif [ "$k" == 16 ]
then 
echo "figlet -f smshadow $n | lolcat ">>/.zshrc
echo "done"
elif [ "$k" == 17 ]
then
echo "figlet $n | lolcat ">>/.zshrc
echo "done"
else
